...
impl<Querier> PackageDatabase for SingleParsedDatabase<'_, Querier> {
...
impl<Querier> Lookup for SingleParsedDatabase<'_, Querier> {
...
impl<Querier> LookupMut for SingleParsedDatabase<'_, Querier> {
    type Error = LookupError;
